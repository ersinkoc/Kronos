...
cancel/retry, target/storage/schedule create/update editing, guarded
...
3. Extend E2E coverage into more retention policy edge cases and release
   verification drills.
4. Expand the WebUI from dashboard shell plus target/storage/schedule editing
   into retention create/update workflows and richer backup drill actions.
...
3. Expand the WebUI beyond the live overview dashboard and
   target/storage/schedule editing into retention create/update workflows and
